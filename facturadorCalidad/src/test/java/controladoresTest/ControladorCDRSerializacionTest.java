...
public class ControladorCDRSerializacionTest {
	...
	public void initGuardarRegistrosEnBD() {
		...
		ControladorCDRs.guardarEnArchivoDeTexto(persistencia, tarificacion, registroCDR);
	}
	
	@Test
	public void cdrGuardadoBDTest() {
		ArrayList<Pair<String,ArrayList<CDR>>> registros = ControladorCDRs.deserializarTodosLosArchivos(persistencia);
